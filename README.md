...
- `chat`：`grok-4.20-fast`、`step-3.5-flash`、`LongCat-Flash-Chat`、`qwen-3-235b-a22b-instruct-2507`、`gpt-oss:120b`、`gpt-oss:20b`
- `ingest`：`LongCat-Flash-Chat`、`gpt-oss:120b`、`gpt-oss:20b`、`deepseek-v4-flash`、`qwen3-next:80b`、`qwen/qwen3.5-122b-a10b`、`qwen3-coder-next`、`qwen3-coder:480b`
- `gpt-oss:20b` 当前作为低风险补容量模型保留；`gemma4:31b` 已因真实流量下的 `429/503` 从默认池移除。
